...
function encriptar () {
  ...
  var reemplazo = document.getElementById("intext").value.replace(/a|e|i|o|u/g, function(m){return{"a":"ai", "e":"enter","i":"imes","o":"ober","u":"ufat"}[m];});
...
function desencriptar () {
  ...
  var desencriptado = document.getElementById("intext").value.replace(/ai|enter|imes|ober|ufat/g, function(m){return{"ai":"a", "enter":"e","imes":"i","ober":"o","ufat":"u"}[m];});
